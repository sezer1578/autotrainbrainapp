...
public class LearningBored extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learning_bored);
        scroll = findViewById(R.id.scroll);
        scroll.setHorizontalFadingEdgeEnabled(false);
        title = findViewById(R.id.title_bored);
        tv1 = findViewById(R.id.EmmaBored);
        tv2 = findViewById(R.id.boredWhen);
