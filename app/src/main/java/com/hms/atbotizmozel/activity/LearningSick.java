...
public class LearningSick extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learning_sick);
        scroll = findViewById(R.id.scroll);
        scroll.setHorizontalFadingEdgeEnabled(false);

        title = findViewById(R.id.title_sick);
        tv1 = findViewById(R.id.EmilySick);
        tv2 = findViewById(R.id.sickWhen);
