...
//
//        toolbar1.setTitle("");
//        toolbarTitle.setText(getResources().getString(R.string.emojiEmotionTest));
        ...
        techList.add(getResources().getString(R.string.shy));
        techList.add(getResources().getString(R.string.grumpy));
        techList.add(getResources().getString(R.string.sick));
