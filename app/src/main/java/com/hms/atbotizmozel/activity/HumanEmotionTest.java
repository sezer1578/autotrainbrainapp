...
//        actionBar.hide();
//        toolbar1.setTitle(" ");
//        toolbarTitle.setText(getResources().getString(R.string.humanEmotionTest));
        ...
        techList.add(getResources().getString(R.string.excıted));
        techList.add(getResources().getString(R.string.fearful));
        techList.add(getResources().getString(R.string.cheerful));
        techList.add(getResources().getString(R.string.anxıous));
        techList.add(getResources().getString(R.string.angry));
        techList.add(getResources().getString(R.string.bored));
        techList.add(getResources().getString(R.string.dısgusted));
        techList.add(getResources().getString(R.string.thınkıng));
