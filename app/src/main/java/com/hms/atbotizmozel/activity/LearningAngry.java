...
public class LearningAngry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learning_angry);
        scroll = findViewById(R.id.scroll);
        scroll.setHorizontalFadingEdgeEnabled(false);
        title = findViewById(R.id.title_ang);
        tv1 = findViewById(R.id.JimAngry);
        tv2 = findViewById(R.id.angryWhen);
