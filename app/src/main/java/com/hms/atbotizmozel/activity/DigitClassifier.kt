...
class DigitClassifier(private val context: Context) {
  ...
  private fun getOutputString(output: FloatArray): String {
    ...
    val url = "https://s3-us-west-2.amazonaws.com/atbprod/ses3/3" + String.format(
      "%d",  maxIndex) + ".mp3"
    ...
    try {
      ...
      Log.e("", "Exception" + e.message + url)
    }
    //return "Sonuç: %d\nGüvenilirlik: %2f".format(maxIndex, output[maxIndex])
    return "%d yazdığını anladım\n".format(maxIndex)
  }
