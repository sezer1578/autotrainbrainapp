...
public class LearningNervous extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learning_nervous);
        scroll = findViewById(R.id.scroll);
        scroll.setHorizontalFadingEdgeEnabled(false);
        title = findViewById(R.id.title_nervous);
        tv1 = findViewById(R.id.AliceNervous);
        tv2 = findViewById(R.id.nervousWhen);
