...
public class LearningHungry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learning_hungry);
        scroll = findViewById(R.id.scroll);
        scroll.setHorizontalFadingEdgeEnabled(false);

        title = findViewById(R.id.title_hungry);
        tv1 = findViewById(R.id.JohnHungry);
        tv2 = findViewById(R.id.hungryWhen);
