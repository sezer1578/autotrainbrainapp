...
public class TestPhasee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_phasee);
        ...
        techList.add(getResources().getString(R.string.hello));
        techList.add(getResources().getString(R.string.goodBye));
        techList.add(getResources().getString(R.string.h_a_y));
        techList.add(getResources().getString(R.string.m_n_i));
        techList.add(getResources().getString(R.string.w_i_y_n));
        techList.add(getResources().getString(R.string.fine_thank));

        map.put(techList.get(0), R.drawable.helloq1);
        map.put(techList.get(1), R.drawable.goodbyeq2);
        map.put(techList.get(2), R.drawable.howareyouq3);
        map.put(techList.get(3), R.drawable.mynameisq4);
        map.put(techList.get(4), R.drawable.whatsyournameq5);
        map.put(techList.get(5), R.drawable.finethankyouq6);
    ...
    public void nextQuestion(View view) {
        ...
        if (index > techList.size() - 1){
            ...
            Intent intent = new Intent(TestPhasee.this, GameOverSociWords.class);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)
    {
        ...
        if(keyCode == KeyEvent.KEYCODE_BACK)
        {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(TestPhasee.this);
            ...
            builder.setPositiveButton(getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    Intent intent = new Intent(TestPhasee.this,ChooseProcessTests.class);
                    startActivity(intent);
                    finish();
